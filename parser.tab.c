...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_token_seq = 26,                 /* token_seq  */
...
static const yytype_int8 yytranslate[] =
{
       ...
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,    22,     2,    18,     2,     2,     2,     2,
      10,    11,     2,     2,    17,     2,    19,     2,     2,     2,
...
static const char *const yytname[] =
{
  ...
  "FLOAT_LIT", "STRING_LIT", "KEYWORD", "OPERATOR", "OTHER", "'('", "')'",
  "'{'", "'}'", "'['", "']'", "';'", "','", "'#'", "'.'", "':'", "'?'",
  "'!'", "'~'", "$accept", "program", "token_seq", "token", YY_NULLPTR
};
